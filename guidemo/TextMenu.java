...
public class TextMenu extends JMenu {
	...
	private final DrawPanel panel;    // the panel whose text is controlled by this menu
	    // Declare the new instance variables
			private JMenu justifyMenu;
	...
	public TextMenu(DrawPanel owner) {
		...
		// Add the justifyMenu to the TextMenu
		justifyMenu = makeJustifyMenu();
		add(justifyMenu);
	}
	    // Create the makeJustifyMenu method
        ...
        ActionListener justifyAction = new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        leftJustify.addActionListener(justifyAction);
        rightJustify.addActionListener(justifyAction);
        centerJustify.addActionListener(justifyAction);
