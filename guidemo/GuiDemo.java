...
public class GuiDemo extends JFrame{
	...
	private JToolBar makeToolbar() {
		...
		// Add ChooseBackgroundAction instances to the toolbar
	...
	public GuiDemo() {
		...
		super("My Favorite Saying");  // Specifies the string for the title bar of the window.
    ...
    private class ChooseBackgroundAction extends AbstractAction {
        ...
        if (text.equals("Custom...")) {
            ...
            putValue(Action.SMALL_ICON, Util.iconFromResource("resources/action_icons/colorchooser.png")); // New icon for Color...
            putValue(Action.SHORT_DESCRIPTION, "<html>Use a solid color for background<br>instead of an image.</html>");
        } else if (!text.equals("Custom...") && !text.equals("Color...")) {
